...
print("Live sessionToken:", session_token[:40], "...")
print("Live sourceToken:", source_token)
print("Live checkoutSessionIdentifier:", checkout_session_id)
...
print("Shopify Deposit Session ID:", vault_session_id)
