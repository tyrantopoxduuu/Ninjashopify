...
queue_token = get_meta("serialized-queueToken") or ""
...
# 4. Correct submitForCompletion Mutation
headers4 = {
    'accept': 'application/json',
    'content-type': 'application/json',
    'origin': 'https://wiredministries.com',
...
mutation_submit = {
    'query': '''mutation SubmitForCompletion($attemptToken: String!, $input: SubmitForCompletionInput!) {
...
r_sub = s.post('https://wiredministries.com/checkouts/unstable/graphql', headers=headers4, json=mutation_submit)
print("Step 4 SubmitForCompletion Response Status:", r_sub.status_code)
print("Step 4 Result Body:", r_sub.text)
