...
# Introspect SubmitForCompletionResult fields
introspect_res = {
    'query': '''query IntrospectSubmit {
      __type(name: "SubmitForCompletionResult") {
        name
        kind
        fields {
          name
...
r_res = s.post('https://wiredministries.com/checkouts/unstable/graphql', headers=headers4, json=introspect_res)
print("SubmitForCompletionResult Introspection:", json.dumps(r_res.json(), indent=2))
