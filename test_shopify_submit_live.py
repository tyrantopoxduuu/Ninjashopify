...
# 4. Execute SubmitForCompletion with NegotiationInput
headers4 = {
    'accept': 'application/json',
    'content-type': 'application/json',
    'origin': 'https://wiredministries.com',
      ...
      submitForCompletion(attemptToken: $attemptToken, input: $input) {
        ... on SubmitSuccess {
          receipt {
            id
            ... on ProcessedReceipt {
              orderIdentity { id buyerIdentifier }
...
print("SubmitForCompletion Response:", json.dumps(r_sub.json(), indent=2))
