...
# 4. Introspect submitForCompletion args
headers4 = {
    'accept': 'application/json',
    'content-type': 'application/json',
    'origin': 'https://wiredministries.com',
...
for field in r_m.json().get('data', {}).get('__type', {}).get('fields', []):
    if field.get('name') == 'submitForCompletion':
        print("submitForCompletion Definition:", json.dumps(field, indent=2))
